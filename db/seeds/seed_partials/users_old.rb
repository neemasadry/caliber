...
random_public_id = Cloudinary::Utils.random_id
timestamp = Time.now
signature = Cloudinary::Utils.api_sign_request({ :public_id => random_public_id, :timestamp => timestamp }, Cloudinary.config.api_secret)
