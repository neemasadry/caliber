...
Brand.create!(
  ...
  name: acosta_forte,
  brand_image_data: uploaded_forte_logo.to_json,
  alias: "forte",
...
Brand.create!(
  ...
  name: amarino_pnp,
  brand_image_data: uploaded_pete_and_pedro_logo.to_json,
  alias: "peteandpedro",
  category: "Grooming & Hygiene",
...
Brand.create!(
    ...
    name: amarino_th,
    brand_image_data: uploaded_teige_hanley_logo.to_json,
    alias: "tiegehanley",
    category: "Grooming & Hygiene",
...
Brand.create!(
    ...
    name: jzuniga_esntls,
    brand_image_data: uploaded_esntls_logo.to_json,
    alias: "esntls",
...
Brand.create!(
    ...
    name: kjenner_ks,
    brand_image_data: uploaded_kylie_skin_logo.to_json,
    alias: "kylieskin",
