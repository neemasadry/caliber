...
class Outfit < ApplicationRecord
  ...
  accepts_nested_attributes_for :outfit_items, allow_destroy: true, reject_if: proc { |attr| attr['productable_type'].blank? || attr['productable_id'].blank? || attr['body_part'].blank?  }
