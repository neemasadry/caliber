class BottomsController < ApplicationController
  ...
  def bottom_params
    params.require(:bottom).permit(:user_id, :brand_id, :name, :description, :retail_price, :retail_price, :type, :gender, :materials, :primary_color, :secondary_color, :product_url)
  end
