...
#  index_bottoms_on_ancestry        (ancestry)
#  index_bottoms_on_body_part_id    (body_part_id)
#  index_bottoms_on_brand_id        (brand_id)
#  index_bottoms_on_category_id     (category_id)
#  index_bottoms_on_discarded_at    (discarded_at)
#  index_bottoms_on_slug            (slug) UNIQUE
#  index_bottoms_on_subcategory_id  (subcategory_id)
...
class BottomTest < ActiveSupport::TestCase
  # test "the truth" do
  #   assert true
  # end
end
